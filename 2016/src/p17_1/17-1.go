...
func GetShortestPath(from au.Coord, to au.Coord, passcode string) string {
...
func Solve() {
	...
	au.AssertStringsEqual(GetShortestPath(au.NewCoord(0, 0), au.NewCoord(3, 3), "ihgpwlah"), "DDRRRD")
	au.AssertStringsEqual(GetShortestPath(au.NewCoord(0, 0), au.NewCoord(3, 3), "kglvqrro"), "DDUDRLRRUDRD")
	au.AssertStringsEqual(GetShortestPath(au.NewCoord(0, 0), au.NewCoord(3, 3), "ulqzkmiv"), "DRURDRUDDLLDLUURRDULRLDUUDDDRR")
	
	fmt.Println(GetShortestPath(au.NewCoord(0, 0), au.NewCoord(3, 3), "dmypynyp"))
