...
func Solve() {
	...
	config.floors[0] = append(config.floors[0], Item{"EL", "G"})
	config.floors[0] = append(config.floors[0], Item{"EL", "M"})
	config.floors[0] = append(config.floors[0], Item{"DI", "G"})
	config.floors[0] = append(config.floors[0], Item{"DI", "M"})
