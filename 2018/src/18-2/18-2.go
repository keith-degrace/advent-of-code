...
func main() {
	...
	foundMagicValue := false
	for i := 0; i < 1000000000; i++ {
		iterate(screen)

		value := getTotalResourceValue(screen)

		// Magic value when the whole thing starts repeating in a 28 value sequence
		if !foundMagicValue && value == 189399 {
			i = 1000000000 - ((1000000000 - i) % 28)
			foundMagicValue = true
		}
	}
